<body id="top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item ">
              <a class="nav-link js-scroll-trigger" href="#forms">Contato</a>
            </li>
  ...
  <div class="container">
    <div class="h2 mb-3" style="text-align: center">
      <h1 class="mt-5 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
        Nossos clientes
      </h1>
    </div>
    <div>
    ...
    <div class="" style="text-align: center">
      <div class="owl-carousel" class="img-fluid px-4">
        <div>
          <h5> </h5>
        </div>
      </div>
  ...
  <main>
    <div class="container">
      <section class="mt-5 wow fadeIn">
        <div class="row">
          <div class="col">
            <h2 class="h2 mb-3" style="text-align: center">
            </h2>
          </div>
        </div>
        <!-- Grid row -->
            ...
            <form role="form" action="/" method="post">
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" placeholder="Digite seu nome completo" id="" name="" required>
                </div>

                <div class="form-group col-md-6">
                  <label for=""><b>Telefone para contato:</b></label>
                  <input type="tel" class="form-control" id="" name="" placeholder="Digite o número telefônico" required>
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for=""><b>E-mail para contato:</b></label>
                  <input type="email" class="form-control" id="" name="" placeholder="Digite o e-mail" required>
                </div>
                <div class="form-group col-md-6">
                  <label for=""><b>Motivo do contato: </b></label>
                  <select required type="text" id="" name="" class="form-control" require>
