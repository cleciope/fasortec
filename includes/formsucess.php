                  ...
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div style="text-align: center">
                          ...
                          <img src="/public/img/svg/ok.svg" class="img-fluid img-responsive" style="width:100px; height: 160px;" />
                          <h4 style="text-align: center">Responderemos o mais breve possível para o e-mail informado abaixo:</h4>
                          <h5 h4 style="font-weight: bold;"><?php echo $email;?></h5>
                        </div>
                    </div>
                  </div>
               </div>
